...
import 'package:plant_app/Marchant/Drawer/Account_Setting/Send_Feedback.dart';
...
class MarchantAccountSetting extends StatefulWidget {
  const MarchantAccountSetting({Key? key}) : super(key: key);

  @override
  State<MarchantAccountSetting> createState() => _MarchantAccountSettingState();
}

class _MarchantAccountSettingState extends State<MarchantAccountSetting> {
                  ...
                  InkWell(
                    onTap: () async {
                      if (_passwordController.text == password) {
                        ...
                        await FirebaseHelper.Auth.logout();
                        await FirebaseHelper.Auth.deleteUser(
                        ...
                        CustomToast().errorToast(
                            context: context, text: "Password Is Wrong");
                      }
                    },
                    child: Container(
