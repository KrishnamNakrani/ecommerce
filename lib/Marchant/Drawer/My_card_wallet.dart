...
class MarchantCards extends StatefulWidget {
  ...
  @override
  State<MarchantCards> createState() => _MarchantCardsState();
}

class _MarchantCardsState extends State<MarchantCards> {
  int current = 0;
