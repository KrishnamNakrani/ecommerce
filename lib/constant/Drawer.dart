                  ...
                  children: [
                    ...
                    ListTile(
                      ...
                      onTap: () {
                        Navigator.of(context).push(MaterialPageRoute(
                            builder: (context) =>
                                const NavigatorScreen(name: "Notifications")));
                      },
                    ),
                    const Divider(
                      height: 0,
                    ...
                    ListTile(
                      ...
                      title: _textUtils.bold16("Your Order", Colors.black),
                      trailing: const Icon(Icons.navigate_next_rounded),
                      onTap: () {
                        Navigator.of(context).push(MaterialPageRoute(
                            builder: (context) =>
                                const NavigatorScreen(name: "Your Order")));
                      },
                    ),
                    const Divider(
                      height: 0,
                    ...
                    ListTile(
                      ...
                      onTap: () {
                        Navigator.of(context).push(MaterialPageRoute(
                            builder: (context) =>
                                const NavigatorScreen(name: "My Addresses")));
                      },
                    ),
                    const Divider(
                      height: 0,
                    ...
                    ListTile(
                      ...
                      onTap: () {
                        Navigator.of(context).push(MaterialPageRoute(
                            builder: (context) =>
                                const NavigatorScreen(name: "Help Center")));
                      },
                    ),
                  ],
                )),
